...
// Writer side only. The reader is split into ILogTailReader / LogTailReader
// so the file-format details (timestamp layout, compaction for the in-app
// viewer, async IO) live in one focused service.
